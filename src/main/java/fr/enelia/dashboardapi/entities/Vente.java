...
public class Vente implements Serializable {
    ...
    private LocalDate dateFinanacement;
    ...
    public LocalDate getDateFinanacement() {
        return dateFinanacement;
    }

    public void setDateFinanacement(LocalDate dateFinanacement) {
        this.dateFinanacement = dateFinanacement;
    }
